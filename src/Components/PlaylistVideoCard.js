  ...
  return (
    <Link to={"/watch?v=" + id}>
      <div className='p-1 m-2 hover:shadow-md hover:shadow-gray-600 hover:bg-gray-50 rounded-md relative flex w-full'>
        ...
        <img src={thumbnail?.maxres? thumbnail?.maxres?.url:(thumbnail?.standard?thumbnail?.standard?.url:(thumbnail?.high?thumbnail?.high?.url:(thumbnail?.medium?thumbnail?.medium?.url:thumbnail?.default?.url)))} alt="video thumbnail" className='rounded-lg h-20 w-36 items-stretch' />
        <div>
